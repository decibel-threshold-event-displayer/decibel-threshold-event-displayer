...
Issues contain a \textit{Definition of Ready} (\fullref{subsubsec:dor}), Acceptance Criteria, as well as a \textit{Definition of Done} (\fullref{subsubsec:dod}).
...
Similarly to the \textit{Definition of Ready} (\fullref{subsubsec:dor}), the \textit{Definition of Done} is a static checklist that is part of
the issue template.
...
In combination with the prioritisation (see\ \fullref{subsec:product_backlog}), this makes for a convenient way for the project team to select issues for the next sprint based on priority (see\ \autoref{fig:sprint_backlog}).
\begin{figure}[H]
    \centering
