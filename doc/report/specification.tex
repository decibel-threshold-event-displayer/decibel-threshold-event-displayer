...
The system delimitation is split into the static system environment \fullref{subsubsec:system_environment}
and the dynamic process environment \fullref{subsubsec:process_environment}.
