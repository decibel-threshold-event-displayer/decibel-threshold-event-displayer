...
The format itself is straight forward\cite{wav_file_format_wikipedia}, the only importend thing is that the whole file is Little-Endian.
...
As mentioned in the introduction, the audio file only contains relativ values.
